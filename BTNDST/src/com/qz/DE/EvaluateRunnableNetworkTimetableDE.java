...
public class EvaluateRunnableNetworkTimetableDE implements Runnable {
    ...
    public EvaluateRunnableNetworkTimetableDE(int ThreadID, int StartIndex, List<Chromosome> SolutionList, List<Double> TmSolutionSufficiency,
    ...
    public void run() {//实验组
        ...
        try {
            ...
            for (int i = 0; i < solutionList.size(); i++) {//遍历所有的解
                ...
                if (DE.BestCost < tmSufficiency) {
                    DE.BestCost = tmSufficiency;
                    DE.BestBusLine = busLines;
                    DE.BestSolution = solutionList.get(i);
                    ...
                    DE.PassengerNotAsignRes = unServedPassengers;
                }
